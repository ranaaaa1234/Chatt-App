...
const Chat = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    const newMessageObj = {
      text: newMessage, // Set the new message text
      avatar: loggedInUser.avatar || "https://i.pravatar.cc/100?img", // Set the user's avatar or a default one
  ...
  return (
    <div className="chat-container">
      ...
      <form onSubmit={handleSendMessage} className="message-form">
        ...
        <button type="submit">Send</button> {/* Button to send the new message */}
      </form>
    </div>
  );
};
